...
buttons = [
    ...
    Button(button_x(6), button_y - CONSTANT, 40, 40, WHITE, "S1", BLACK, 1),
    Button(button_x(7), button_y - CONSTANT, 40, 40, WHITE, "S2", BLACK, 2),
    Button(button_x(8), button_y - CONSTANT, 40, 40, WHITE, "S3", BLACK, 3),
    Button(button_x(9), button_y - CONSTANT, 40, 40, WHITE, "S5", BLACK, 5),
    Button(button_x(10), button_y - CONSTANT, 40, 40, RED, "BU", BLACK)
]
